...
if(s==null){ %>
	...
	세션ID : <%=session2.getId() %>
	<input type="button" value="Logout" onClick="logout.jsp"/>
		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href="index.html" class="logo pull-left"><img src="themes/images/bookstore.jpg" class="site_logo" alt=""></a>
			...
			<img class="pageBanner" src="themes/images/bookstore.jpg" >
			</section>		
