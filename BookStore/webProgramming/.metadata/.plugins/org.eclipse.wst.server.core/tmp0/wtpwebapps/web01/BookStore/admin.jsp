...
<body>
   ...
   <div id="top-bar" class="container">
            ...
            <div class="span8">
               <div class="account pull-right">
                  <ul class="user-menu">         
                     ...
                     <li><img src="http://download.seaicons.com/icons/icons8/windows-8/512/Users-Edit-User-icon.png" width="25" height="25"></li>      
                  </ul>
               </div>
            </div>
         </div>
    ...
    %>
        ...
        <a href="product_detail.html" class="title">ISCBN: <%= rs.getString("ISBN") %></a><br/>
        <a href="products.html" class="category">Title: <%= rs.getString("title") %></a>
